...
from panns.utils.utilities import create_folder
...
def plot_long_fig(args):
    ...
    line1te = _plot_4_rows(maps_panns_cnn14, ax1b, ax2b, ax3b, ax4b, c="r", linewidth=linewidth, label="AP with CNN14")
    line2te = _plot_4_rows(
        maps_panns_mobilenetv1, ax1b, ax2b, ax3b, ax4b, c="b", linewidth=linewidth, label="AP with MobileNetV1"
    )
