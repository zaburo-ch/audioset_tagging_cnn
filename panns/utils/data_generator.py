...
from panns.utils.utilities import int16_to_float32
...
class TrainSampler(Base):
    def __init__(self, indexes_hdf5_path, batch_size, black_list_csv=None, random_seed=1234):
        ...
        Args:
          ...
          random_seed: int
        """
        super(TrainSampler, self).__init__(indexes_hdf5_path, batch_size, black_list_csv, random_seed)
        ...
        while True:
            ...
            while i < batch_size:
                ...
                if self.audio_names[index] in self.black_list_names:
                    ...
                    batch_meta.append(
                        {"hdf5_path": self.hdf5_paths[index], "index_in_hdf5": self.indexes_in_hdf5[index]}
                    )
                    i += 1
...
class BalancedTrainSampler(Base):
    def __init__(self, indexes_hdf5_path, batch_size, black_list_csv=None, random_seed=1234):
        ...
        logging.info("samples_num_per_class: {}".format(self.samples_num_per_class.astype(np.int32)))
...
class AlternateTrainSampler(Base):
    def __init__(self, indexes_hdf5_path, batch_size, black_list_csv=None, random_seed=1234):
        ...
        Args:
          ...
          random_seed: int
        """
        self.sampler1 = TrainSampler(indexes_hdf5_path, batch_size, black_list_csv, random_seed)

        self.sampler2 = BalancedTrainSampler(indexes_hdf5_path, batch_size, black_list_csv, random_seed)
    ...
    def state_dict(self):
        state = {"sampler1": self.sampler1.state_dict(), "sampler2": self.sampler2.state_dict()}
        return state
