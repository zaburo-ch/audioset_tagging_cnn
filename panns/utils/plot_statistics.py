...
from panns.utils.utilities import create_folder, d_prime
...
def plot(args):
    ...
    class_labels_indices_path = os.path.join(dataset_dir, "metadata", "class_labels_indices.csv")
    ...
    if select == "1_cnn13":
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn13", "clip_bce", "balanced", "mixup", 32
        )
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn13", "clip_bce", "balanced", "none", 32
        )
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn13_gwrp", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn13_att", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="g", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "ResNet18", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "ResNet34", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="k", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "ResNet50", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="c", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "DenseNet121", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "DenseNet201", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="g", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn5", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn9", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="g", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 500, 64, 50, 14000, "full_train", "Cnn13", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 640, 64, 50, 14000, "full_train", "Cnn13", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="g", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 1000, 64, 50, 14000, "full_train", "Cnn13", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="k", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn13_emb32", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn13_emb128", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="g", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn13_emb512", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="k", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "MobileNetV1", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "MobileNetV2", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="g", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn1d_LeeNet", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="g", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn1d_LeeNet18", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn1d_DaiNet", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="k", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn1d_ResNet34", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="c", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn1d_ResNet50", "clip_bce", "balanced", "mixup", 32
        )
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn13_SpAndWav", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn13_WavCnn2d", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="g", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn14", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="r", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn14", "clip_bce", "none", "none", 32
        )
        (line,) = ax.plot(bal_map, color="g", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn14", "clip_bce", "balanced", "none", 32
        )
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "balanced_train", "Cnn14", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="r", alpha=bal_alpha)
        (line,) = ax.plot(test_map, label="cnn14,balanced,mixup", color="r", alpha=test_alpha)
        lines.append(line)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "balanced_train", "Cnn14", "clip_bce", "none", "none", 32
        )
        (line,) = ax.plot(bal_map, color="g", alpha=bal_alpha)
        (line,) = ax.plot(test_map, label="cnn14,none,none", color="g", alpha=test_alpha)
        lines.append(line)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "balanced_train", "Cnn14", "clip_bce", "balanced", "none", 32
        )
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        (line,) = ax.plot(test_map, label="cnn14,balanced,none", color="b", alpha=test_alpha)
        lines.append(line)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn14_16k", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="g", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn14_8k", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 2048, 320, 64, 50, 14000, "full_train", "Cnn14", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="r", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 32, 50, 14000, "full_train", "Cnn14_mel32", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="r", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 128, 50, 14000, "full_train", "Cnn14_mel128", "clip_bce", "balanced", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="r", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn14", "clip_bce", "alternate", "mixup", 32
        )
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics(
            "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn13_no_specaug", "clip_bce", "none", "none", 32
        )
        (line,) = ax.plot(bal_map, color="c", alpha=bal_alpha)
...
def plot_for_paper(args):
    ...
    if select == "2_all":
        ...
        (line,) = ax.plot(
            test_map, label="CNN14,bal,mixup-wav (1.9m)", color="y", alpha=test_alpha, linewidth=linewidth
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha, linewidth=linewidth)
        (line,) = ax.plot(
            test_map, label="CNN14,no-bal,no-mixup (1.9m)", color="b", alpha=test_alpha, linewidth=linewidth
        )
        lines.append(line)
...
def plot_for_paper2(args):
    ...
    if True:
        ...
        (line,) = ax[0, 1].plot(
            test_map, label="CNN14,bal,mixup (1.9m)", color="r", alpha=test_alpha, linewidth=linewidth
        )
        lines.append(line)
        ...
        (line,) = ax[0, 1].plot(
            test_map, label="CNN14,bal,no-mixup (1.9m)", color="g", alpha=test_alpha, linewidth=linewidth
        )
        lines.append(line)
        ...
        (line,) = ax[0, 1].plot(
            test_map, label="CNN14,bal,no-mixup (20k)", color="k", alpha=test_alpha, linewidth=linewidth
        )
        lines.append(line)
        ...
        (line,) = ax[0, 1].plot(
            test_map, label="CNN14,bal,mixup (20k)", color="m", alpha=test_alpha, linewidth=linewidth
        )
        lines.append(line)
...
def plot_class_iteration(args):
    ...
    statistics_dict = _load_metrics(
        "main", 32000, 1024, 320, 64, 50, 14000, "full_train", "Cnn13", "clip_bce", "balanced", "mixup", 32, iteration
    )
...
def summary_stats(args):
    ...
    bal_train_metrics = get_avg_stats(
        old_workspace, bgn_iter=10000, fin_iter=50001, interval_iter=5000, filename="tmp127_re", data_type="train"
    )
    eval_metrics = get_avg_stats(
        old_workspace, bgn_iter=10000, fin_iter=50001, interval_iter=5000, filename="tmp127_re", data_type="test"
    )
...
def plot_long_fig(args):
    ...
    line2te = _plot_4_rows(
        maps_mobilenetv1, ax1b, ax2b, ax3b, ax4b, c="b", linewidth=linewidth, label="AP with MobileNetV1"
    )
    ...
    ax1b.scatter(
        np.arange(N)[sorted_rate != None], sorted_rate[sorted_rate != None], s=12, c="r", linewidth=0.8, marker="+"
    )
    ax2b.scatter(
        np.arange(N)[sorted_rate != None], sorted_rate[sorted_rate != None], s=12, c="r", linewidth=0.8, marker="+"
    )
...
def plot_flops(args):
    ...
    mAPs = np.array(
        [0.343, 0.380, 0.431, 0.430, 0.434, 0.429, 0.389, 0.383, 0.295, 0.266, 0.336, 0.365, 0.355, 0.389, 0.439]
    )
...
def print_results(args):
    ...
    # partial
    (mAP, mAUC, dprime) = _load_metrics_classwise(
        "main", 32000, 1024, 320, 64, 50, 14000, "partial_0.8_full_train", "Cnn14", "clip_bce", "balanced", "mixup", 32
    )

    (mAP, mAUC, dprime) = _load_metrics_classwise(
        "main", 32000, 1024, 320, 64, 50, 14000, "partial_0.5_full_train", "Cnn14", "clip_bce", "balanced", "mixup", 32
    )
