...
from panns.pytorch.pytorch_utils import move_data_to_device
from panns.utils import config
from panns.utils.utilities import create_folder, get_filename
...
def sound_event_detection(args):
    ...
    stft = librosa.core.stft(
        y=waveform[0].data.cpu().numpy(), n_fft=window_size, hop_length=hop_size, window="hann", center=True
    )
